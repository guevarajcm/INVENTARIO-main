<?php
    ...
    if($check_usuario->rowCount()==1){
    	...
    	if($check_productos->rowCount()<=0){
			...
			/* if ($check_usuario->rowCount()==24) {
				echo'<div class="notification is-info is-light">
						  <strong>!NO SE PUEDE ELIMINAR ESTE USUARIO</strong><br>
						  Los datos de este usuario no se pueden eliminar porque es el administrador
						  </div>
						  ';
			}*/ 
