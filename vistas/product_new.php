		...
		<div class="column">
		    	<div class="control">
					<label>Sustancia activa</label>
				  	<input class="input" type="text" name="sustancia_activa" pattern="[a-zA-Z0-9áéíóúÁÉÍÓÚñÑ().,$#\-\/ ]{1,70}" maxlength="70" required >
				</div>
		  	</div>
		    <div class="column">
		    	<div class="control">
					<label>Caducidad</label>
				  	<input class="input" type="text" name="caducidad" pattern="[a-zA-Z0-9áéíóúÁÉÍÓÚñÑ().,$#\-\/ ]{1,70}" maxlength="70" required >
				</div>
		  	</div>
		</div>
		<div class="columns">
		    <div class="column">
		    	<div class="control">
					<label>Proovedor</label>
				  	<input class="input" type="text" name="prove_prod" pattern="[a-zA-Z0-9áéíóúÁÉÍÓÚñÑ().,$#\-\/ ]{1,70}" maxlength="70" required >
				</div>
		  	</div>
		  	<div class="column">
		    	<div class="control">
